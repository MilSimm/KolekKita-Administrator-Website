...
import type { Booking, UserWithFirebaseData as User } from "@shared/schema";
...
export const LiveTracking = () => {
  ...
  const { data: activeBookings, loading: bookingsLoading } = useFirestoreCollection<any>(
    "bookings", 
    [where("status", "in", ["assigned", "in_progress"])]
  );
  
  const { data: onlineDrivers, loading: driversLoading } = useFirestoreCollection<any>(
    "users",
